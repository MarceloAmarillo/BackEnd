...
public class CProyectos {
   @Autowired
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproyecto){      
        ...
        Proyectos proyect= new Proyectos(dtoproyecto.getNombreP(),dtoproyecto.getDescripcionP(),dtoproyecto.getImg(),dtoproyecto.getUrl());
        sProyectos.save(proyect);
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyectos dtoproyecto){
        ...
        if(sProyectos.existsByNombreP(dtoproyecto.getNombreP()) && sProyectos.getByNOmbreE(dtoproyecto.getNombreP()).get().getId() != id)
